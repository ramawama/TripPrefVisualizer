        ...
        <div className="hero min-h-screen" style={{backgroundImage: 'url(/clouds.jpg)'}}>
            ...
            <div className="hero-content text-center text-neutral-content">
              ...
              <h1 className="mb-5 text-5xl font-bold">A B O U T</h1>
                ...
                <br />
                <p> Anna Priore is a first year Digital Arts and Sciences Major at the University of Florida. 
                ...
                <br /><p>Alina is a dedicated second-year Computer Science major with a minor in Chinese at the University of Florida. 
                    ...
                    She values her time outdoors and cherishes moments spent with friends and family.</p>
              </div>
            </div>
          </div>
